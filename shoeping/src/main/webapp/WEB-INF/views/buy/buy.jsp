					...
					<c:forEach items="${list }" var="vo">
						...
						<tr class="dataRow">
							<td> <!-- 상품이미지 -->
								<div class="imgDiv">
									<center>
									<img src="${vo.fileName}" style="height: 150px;">
									</center>
								</div>
							</td>
							...
							<td> <!-- 출력 상품정보 -->
					            ...
					            <div>Color : ${vo.color}</div>
					            <div>Size : ${vo.buysize}</div>
							</td>
							<td> <div>공짜</div></td> <!-- 배송비 -->
							<td><div>${vo.quantity}</div></td> <!-- 수량 -->
...
<!-- ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■ 상단 버튼 & 이벤트 ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■-->
				...
				<!-- 전달할 상품 데이터 -->
				<form action="buy.do" method="post" varStatus="vs">
