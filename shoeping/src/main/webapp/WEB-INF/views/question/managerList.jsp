					...
					if(login != null){
						if(login == qnaData.id){
							...
							$(".qnaBtns").html(`
		                		...
		                		<a href="delete.do?qno=${ '${qnaData.qno}' }&itemNo=${ '${qnaData.itemNo}' }"
...
<h1>문의</h1>
	...
	<c:if test="${pageObject.endPage > 1 }">
		<div>
			<pageNav:pageNav listURI="managerList.do" pageObject="${pageObject}"></pageNav:pageNav>
		</div>
	</c:if>
</div>
<!-- aUpdateModal -->
